...
class NewgubacrawlSpider(Spider):
            ...
            for item in items:
                ...
                if test is not None:
                    ...
                    if len(text) == 40:
                        ...
                        text_request = Request(url="https://guba.eastmoney.com" + link, callback=self.get_text,
                                               headers=self.headers)
                        text_request.meta["item"] = postItem
                        yield text_request
                    else:
    ...
    def get_text(self, response):
        ...
        if post_info is not None:
            ...
            if stoke_code == postItem["stoke_code"]:                                         # 通过页面判断此页是否为正常页面
